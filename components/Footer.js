...
export default function Footer() {
  return (
    <footer className="text-center font-bold pb-4 px-4 mt-1 bg-white w-full sticky bottom-0">
      <nav className="flex justify-center items-center text-center mb-4 py-2 border-b border-t">
      ...
      <p className="font-[500] text-sm"><span className="font-bold">&copy;</span> Phoebe Koh 2025</p>
    </footer>
  );
}
