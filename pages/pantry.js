        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            <div className="flex flex-col w-full max-w-md mx-auto min-h-screen bg-white shadow-lg">
                <Head>
                    ...
                    <meta name="description" content="Select your dietary restrictions and allergies to filter recipes. Choose from dairy-free, gluten-free, nut-free, egg-free, sesame-free, and vegan options." />
                </Head>
                <Header />
